...
package com.sbby.aqzlgj.kotlin.ui.component
...
import com.sbby.aqzlgj.kotlin.ui.component.liquid.InnerShadow
import com.sbby.aqzlgj.kotlin.ui.component.liquid.innerShadow
import com.sbby.aqzlgj.kotlin.ui.component.liquid.lens
import com.sbby.aqzlgj.kotlin.ui.component.liquid.rememberCombinedBackdrop
import com.sbby.aqzlgj.kotlin.ui.component.liquid.vibrancy
import com.sbby.aqzlgj.kotlin.ui.component.miuix.animation.DampedDragAnimation
import com.sbby.aqzlgj.kotlin.ui.component.miuix.animation.InteractiveHighlight
import com.sbby.aqzlgj.kotlin.ui.theme.isInDarkTheme
...
fun FloatingBottomBar(
    ...
    val tabsBackdrop = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
    ...
    val combinedBackdrop = if (backdrop != null && tabsBackdrop != null) rememberCombinedBackdrop(backdrop, tabsBackdrop) else null
            ...
            CompositionLocalProvider(
                ...
                Row(
                    Modifier
                        ...
                        .graphicsLayer { translationX = panelOffset }
                        .then(if (isBlurEnabled && backdrop != null) Modifier.drawBackdrop(
                            backdrop = backdrop,
                            shape = { pillShape },
                            effects = {
                                vibrancy()
            ...
            if (isBlurEnabled) {
                Box(
                    Modifier
                        ...
                        .then(if (combinedBackdrop != null) Modifier.drawBackdrop(
